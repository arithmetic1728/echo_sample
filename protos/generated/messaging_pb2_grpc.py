...
class MessagingStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateRoom = channel.unary_unary(
        ...
        request_serializer=messaging__pb2.CreateRoomRequest.SerializeToString,
        response_deserializer=messaging__pb2.Room.FromString,
        )
    self.GetRoom = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/GetRoom',
        request_serializer=messaging__pb2.GetRoomRequest.SerializeToString,
        response_deserializer=messaging__pb2.Room.FromString,
        )
    self.UpdateRoom = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/UpdateRoom',
        request_serializer=messaging__pb2.UpdateRoomRequest.SerializeToString,
        response_deserializer=messaging__pb2.Room.FromString,
        )
    self.DeleteRoom = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/DeleteRoom',
        request_serializer=messaging__pb2.DeleteRoomRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
    self.ListRooms = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/ListRooms',
        request_serializer=messaging__pb2.ListRoomsRequest.SerializeToString,
        response_deserializer=messaging__pb2.ListRoomsResponse.FromString,
        )
    self.CreateBlurb = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/CreateBlurb',
        request_serializer=messaging__pb2.CreateBlurbRequest.SerializeToString,
        response_deserializer=messaging__pb2.Blurb.FromString,
        )
    self.GetBlurb = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/GetBlurb',
        request_serializer=messaging__pb2.GetBlurbRequest.SerializeToString,
        response_deserializer=messaging__pb2.Blurb.FromString,
        )
    self.UpdateBlurb = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/UpdateBlurb',
        request_serializer=messaging__pb2.UpdateBlurbRequest.SerializeToString,
        response_deserializer=messaging__pb2.Blurb.FromString,
        )
    self.DeleteBlurb = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/DeleteBlurb',
        request_serializer=messaging__pb2.DeleteBlurbRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
    self.ListBlurbs = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/ListBlurbs',
        request_serializer=messaging__pb2.ListBlurbsRequest.SerializeToString,
        response_deserializer=messaging__pb2.ListBlurbsResponse.FromString,
        )
    self.SearchBlurbs = channel.unary_unary(
        '/google.showcase.v1beta1.Messaging/SearchBlurbs',
        request_serializer=messaging__pb2.SearchBlurbsRequest.SerializeToString,
        response_deserializer=google_dot_longrunning_dot_operations__pb2.Operation.FromString,
        )
    self.StreamBlurbs = channel.unary_stream(
        '/google.showcase.v1beta1.Messaging/StreamBlurbs',
        request_serializer=messaging__pb2.StreamBlurbsRequest.SerializeToString,
        response_deserializer=messaging__pb2.StreamBlurbsResponse.FromString,
        )
    self.SendBlurbs = channel.stream_unary(
        '/google.showcase.v1beta1.Messaging/SendBlurbs',
        request_serializer=messaging__pb2.CreateBlurbRequest.SerializeToString,
        response_deserializer=messaging__pb2.SendBlurbsResponse.FromString,
        )
...
def add_MessagingServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateRoom': grpc.unary_unary_rpc_method_handler(
          servicer.CreateRoom,
          request_deserializer=messaging__pb2.CreateRoomRequest.FromString,
          response_serializer=messaging__pb2.Room.SerializeToString,
      ),
      'GetRoom': grpc.unary_unary_rpc_method_handler(
          servicer.GetRoom,
          request_deserializer=messaging__pb2.GetRoomRequest.FromString,
          response_serializer=messaging__pb2.Room.SerializeToString,
      ),
      'UpdateRoom': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateRoom,
          request_deserializer=messaging__pb2.UpdateRoomRequest.FromString,
          response_serializer=messaging__pb2.Room.SerializeToString,
      ),
      'DeleteRoom': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteRoom,
          request_deserializer=messaging__pb2.DeleteRoomRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      'ListRooms': grpc.unary_unary_rpc_method_handler(
          servicer.ListRooms,
          request_deserializer=messaging__pb2.ListRoomsRequest.FromString,
          response_serializer=messaging__pb2.ListRoomsResponse.SerializeToString,
      ),
      'CreateBlurb': grpc.unary_unary_rpc_method_handler(
          servicer.CreateBlurb,
          request_deserializer=messaging__pb2.CreateBlurbRequest.FromString,
          response_serializer=messaging__pb2.Blurb.SerializeToString,
      ),
      'GetBlurb': grpc.unary_unary_rpc_method_handler(
          servicer.GetBlurb,
          request_deserializer=messaging__pb2.GetBlurbRequest.FromString,
          response_serializer=messaging__pb2.Blurb.SerializeToString,
      ),
      'UpdateBlurb': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateBlurb,
          request_deserializer=messaging__pb2.UpdateBlurbRequest.FromString,
          response_serializer=messaging__pb2.Blurb.SerializeToString,
      ),
      'DeleteBlurb': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteBlurb,
          request_deserializer=messaging__pb2.DeleteBlurbRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
      'ListBlurbs': grpc.unary_unary_rpc_method_handler(
          servicer.ListBlurbs,
          request_deserializer=messaging__pb2.ListBlurbsRequest.FromString,
          response_serializer=messaging__pb2.ListBlurbsResponse.SerializeToString,
      ),
      'SearchBlurbs': grpc.unary_unary_rpc_method_handler(
          servicer.SearchBlurbs,
          request_deserializer=messaging__pb2.SearchBlurbsRequest.FromString,
          response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ),
      'StreamBlurbs': grpc.unary_stream_rpc_method_handler(
          servicer.StreamBlurbs,
          request_deserializer=messaging__pb2.StreamBlurbsRequest.FromString,
          response_serializer=messaging__pb2.StreamBlurbsResponse.SerializeToString,
      ),
      'SendBlurbs': grpc.stream_unary_rpc_method_handler(
          servicer.SendBlurbs,
          request_deserializer=messaging__pb2.CreateBlurbRequest.FromString,
          response_serializer=messaging__pb2.SendBlurbsResponse.SerializeToString,
      ),
