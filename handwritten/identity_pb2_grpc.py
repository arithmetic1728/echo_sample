...
class IdentityStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateUser = channel.unary_unary(
        ...
        response_deserializer=identity__pb2.User.FromString,
        )
    ...
    self.UpdateUser = channel.unary_unary(
        ...
        request_serializer=identity__pb2.UpdateUserRequest.SerializeToString,
        response_deserializer=identity__pb2.User.FromString,
        )
...
def add_IdentityServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateUser': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=identity__pb2.User.SerializeToString,
      ),
      ...
      'UpdateUser': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateUser,
          request_deserializer=identity__pb2.UpdateUserRequest.FromString,
          response_serializer=identity__pb2.User.SerializeToString,
      ),
