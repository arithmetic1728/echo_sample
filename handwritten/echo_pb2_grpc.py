...
class EchoStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Expand = channel.unary_stream(
        ...
        request_serializer=echo__pb2.ExpandRequest.SerializeToString,
        response_deserializer=echo__pb2.EchoResponse.FromString,
        )
    ...
    self.PagedExpand = channel.unary_unary(
        ...
        request_serializer=echo__pb2.PagedExpandRequest.SerializeToString,
        response_deserializer=echo__pb2.PagedExpandResponse.FromString,
        )
    self.Wait = channel.unary_unary(
        '/google.showcase.v1beta1.Echo/Wait',
        request_serializer=echo__pb2.WaitRequest.SerializeToString,
        response_deserializer=google_dot_longrunning_dot_operations__pb2.Operation.FromString,
        )
    self.Block = channel.unary_unary(
        '/google.showcase.v1beta1.Echo/Block',
        request_serializer=echo__pb2.BlockRequest.SerializeToString,
        response_deserializer=echo__pb2.BlockResponse.FromString,
        )
...
def add_EchoServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Expand': grpc.unary_stream_rpc_method_handler(
          servicer.Expand,
          request_deserializer=echo__pb2.ExpandRequest.FromString,
          response_serializer=echo__pb2.EchoResponse.SerializeToString,
      ),
      ...
      'PagedExpand': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=echo__pb2.PagedExpandRequest.FromString,
          response_serializer=echo__pb2.PagedExpandResponse.SerializeToString,
      ),
      'Wait': grpc.unary_unary_rpc_method_handler(
          servicer.Wait,
          request_deserializer=echo__pb2.WaitRequest.FromString,
          response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ),
      'Block': grpc.unary_unary_rpc_method_handler(
          servicer.Block,
          request_deserializer=echo__pb2.BlockRequest.FromString,
          response_serializer=echo__pb2.BlockResponse.SerializeToString,
      ),
  }
